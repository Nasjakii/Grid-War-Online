...
function scr_hover_text_header(box_arr, str, box_color, text_color, font, offset = 20){
	
	draw_set_font(font);
	hover_message_width = string_width(str) + 100;
	hover_message_box_array = box_arr;
	hover_message_str = str;
	hover_message_box_color = box_color;
...
function scr_hover_text_body(str, box_color, text_color, font){

	hover_message_body = true;
	hover_message_body_str = str;
	hover_message_body_box_color = c_white;
