...
if grabbing {
	...
	new_x = clamp(new_x, -width * 0.9, objGrid.field_width * tile_size * 0.9);
	new_y = clamp(new_y, -height * 0.9, objGrid.field_height * tile_size * 0.9);
...
if !grabbing {
	...
	if keyboard_check_released(vk_space) {
		camera_set_view_pos(cam, (base_pos[0] + 0.5) * tile_size - width / 2, (base_pos[1] + 0.5) * tile_size - height / 2);
	}
}